...
Although you can use the index.html by just opening it in Google Chrome, it's recommended to provide all resources through a web server (requires Java). In the root directory, you'll find a script for your operating system (called "runLocalWebServer") which launches a very small web server.
